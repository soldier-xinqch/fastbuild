...
public class SensitivewordFilter {
    ...
    public static final String sensitiveWordsCacheKey = "WORDS_CACHE_KEY";
    ...
    public SensitivewordFilter(String filePath){
        try {
            SensitiveWordInit sensitiveWord = new SensitiveWordInit();
            sensitiveWord.setWordsReproPath(filePath);
            sensitiveWordMap = sensitiveWord.initKeyWord();
            //这里可以放置缓存  推荐使用本地缓存
    ...
    public int CheckSensitiveWord(String txt,int beginIndex,int matchType){
        if(null == sensitiveWordMap) return 0;
